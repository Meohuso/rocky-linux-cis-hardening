...
#
# CIS 1.1.5.1 - Ensure /var/log is a separate partition.
#
# SPDX-License-Identifier: MIT
#

readonly RLCH_CIS_1_1_5_1_MOUNT_TARGET="/var/log"

RLCH_CIS_1_1_5_1_FSTAB="${RLCH_CIS_1_1_5_1_FSTAB:-${RLCH_MOUNT_FSTAB:-/etc/fstab}}"

##
# Check whether /var/log has its own persistent and runtime mount.
#
# Returns:
...
check() {
    ...
    mount_check_partition \
        "${RLCH_CIS_1_1_5_1_MOUNT_TARGET}" \
        "${RLCH_CIS_1_1_5_1_FSTAB}"
    result=$?
...
##
# Validate CIS control 1.1.5.1 after remediation.
#
# Returns:
