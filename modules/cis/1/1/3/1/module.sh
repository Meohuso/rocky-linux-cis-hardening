...
readonly RLCH_CIS_1_1_3_1_MOUNT_TARGET="/var"

RLCH_CIS_1_1_3_1_FSTAB="${RLCH_CIS_1_1_3_1_FSTAB:-${RLCH_MOUNT_FSTAB:-/etc/fstab}}"

##
# Check whether /var has its own persistent and runtime mount.
#
# Returns:
...
check() {
    ...
    mount_check_partition \
        "${RLCH_CIS_1_1_3_1_MOUNT_TARGET}" \
        "${RLCH_CIS_1_1_3_1_FSTAB}"
    result=$?
...
##
# Validate CIS control 1.1.3.1 after remediation.
#
# Returns:
