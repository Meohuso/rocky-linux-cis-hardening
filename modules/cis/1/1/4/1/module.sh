...
#
# CIS 1.1.4.1 - Ensure /var/tmp is a separate partition.
#
# SPDX-License-Identifier: MIT
#

readonly RLCH_CIS_1_1_4_1_MOUNT_TARGET="/var/tmp"

RLCH_CIS_1_1_4_1_FSTAB="${RLCH_CIS_1_1_4_1_FSTAB:-${RLCH_MOUNT_FSTAB:-/etc/fstab}}"

##
# Check whether /var/tmp has its own persistent and runtime mount.
#
# Returns:
...
check() {
    ...
    mount_check_partition \
        "${RLCH_CIS_1_1_4_1_MOUNT_TARGET}" \
        "${RLCH_CIS_1_1_4_1_FSTAB}"
    result=$?
...
##
# Validate CIS control 1.1.4.1 after remediation.
#
# Returns:
