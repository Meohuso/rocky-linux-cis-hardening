...
setup() {
    ...
    setup_kernel_module_test_environment \
        "1.1.1.1" \
        "cramfs" \
        "rlch-cis-1.1.1.1-cramfs.conf"

    RLCH_CIS_1_1_1_1_MODPROBE_DIRECTORY="${RLCH_TEST_MODPROBE_DIRECTORY}"
    RLCH_CIS_1_1_1_1_CONFIGURATION_FILE="${RLCH_TEST_KERNEL_CONFIGURATION_FILE}"
